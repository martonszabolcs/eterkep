...
import { Platform, StyleSheet, Text, View, TouchableHighlight, Dimensions, StatusBar, ScrollView, Image, Modal, Switch, TouchableOpacity, Linking, WebView, ListView, AsyncStorage, TextInput, Easing, DrawerLayoutAndroid } from 'react-native';
  ...
  render() {
    ...
    return (
      ...
      onRequestClose = {() => {
        ...
        textAlign: 'center',
        fontSize: 30
      }}>Szeretettel üdvözlünk az E-Térkép első felhasználói, tesztelői között!</Text>
                <Image
      ...
      renderRow={ (rowData, sectionID, rowID, highlightRow) => (
        ...
        style={{
          ...
          borderRadius: 10
                ...
                <Text numberOfLines={2} style={[styles.cim, {
          color: 'black',
          marginLeft: 5,
          marginTop: 5,
          marginRight: 5,
          ...
          fontSize: 12
                ...
                <Text numberOfLines={4} style={[styles.cim, {
          color: 'black',
          marginLeft: 5,
          marginTop: 5,
          marginRight: 5,
      ...
      style={{
        ...
        <TouchableOpacity  onPress={() => Actions.bongeszes({
        tipus: 1
      })}>
          <View style={[styles.menu1]}>
            <Image
